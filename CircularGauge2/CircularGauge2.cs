...
namespace GaugeControls
{
    ...
    /// </summary>
    public partial class CircularGauge2 : UserControl
    {
        ...
        private void dessinGraduations(PaintEventArgs e) 
        {
            ...
            for (int i = 0; i <= nbg; i++)
            {
                ...
                e.Graphics.DrawString(valeurGraduation+"", drawFont, drawBrush2, new PointF(x1, y1), drawFormat);
